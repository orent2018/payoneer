...
//       Optional pulish to docker hub using credentials added to Jenkins of type usernamePassword - requires and additional docker pull stage
//       in deploy stage below.
